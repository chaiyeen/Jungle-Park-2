...
/**
 * PApplet inherits its predefined properties and behaviors to JunglePark class (makes JunglePark class to be a PApplet)
 * PApplet is a specific type that represents the Processing window for a graphic application or program
 * which provides good ways to create a new window and draw graphics onto it 
...
public class JunglePark extends PApplet {
  ...
  // protected field : package visibility; also visible to any subclasses
   ...
   */
  @Override
  public void setup() { // this method runs once when the PApplet program first starts
  ...
  public void mousePressed() {
    // traverse listGUI and call mousePressed() of the first graphical object which the mouse is over
    for (int i = 0; i < listGUI.size(); i++)
  ...
  public static void main(String[] args) {
    ...
    // of the PApplet class to run as parameter)
	  // and not Utility.startApplication() method as we did for P2 because Utility class is 
	  // not provided in the processing jar file for P5

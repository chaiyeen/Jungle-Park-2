...
public class JungleParkTests extends JunglePark {
  ...
  private static JunglePark park; // PApplet object that represents the display window of this program
 ...
 // This is an example. You can define your own test scenario for this method
    ...
    Tiger t1 = new Tiger(park);
    Tiger t2 = new Tiger(park);
    // Set deer at position(400,200)
    d.setPositionX(400);
    d.setPositionY(200);
    // Set first tiger at position(100,100)
    t1.setPositionX(100); // tiger is 200px away from deer
    t1.setPositionY(200);
    // Set second tiger at position(300,200)
    t2.setPositionX(300); // tiger is 100px away from deer
    t2.setPositionY(200);
  ...
  public static boolean test1DeerScanForThreatMethod() {
    ...
    // Set deer at position(101,200)
    d.setPositionX(101);
    d.setPositionY(200);
    // Set first tiger at position(100,200)
    t1.setPositionX(100); // tiger is 1px away from deer
    t1.setPositionY(200);
    ...
    if(d.scanForThreat(175) == false) {
    	...
    	System.out.println("Deer's ScanForThreatMethod is returning false when it should return true.");
    	passed = false;
    }
    park.listGUI.clear(); // clear all the content of listGUI to get ready for a next scenario
  ...
  public static boolean test2DeerScanForThreatMethod() {
    ...
    // Set deer at position(500,500)
    d.setPositionX(500);
    d.setPositionY(500);
    // Set first tiger at position(100,200)
    t1.setPositionX(100); // tiger is 400px away from deer
    t1.setPositionY(500);
    //should return false since tiger doesn't present within a specific range distance from it
    
    if(d.scanForThreat(175) == false) {
    	passed = true;
    }
    else {
    	System.out.println("Deer's ScanForThreatMethod is returning true when it should return false.");
    	passed = false;
    }
    park.listGUI.clear(); // clear all the content of listGUI to get ready for a next scenario
    return passed;
